...
- Earlier **Software Engineer @ ENTIIS Pte Ltd** — delivered enterprise Elastic Stack deployments and logging pipelines for banking/government clients.

Side project: **[Formularizer](https://formularizer.com)** — AI-powered spreadsheet formula generator (**20,000+ users**, **2,000+ MAU**).

**M.Sc. Computer Science @ University of Passau** (Oct 2025 – Present)

📫 **Email:** [dminhvu.work@gmail.com](mailto:dminhvu.work@gmail.com)  
...
- **Cloud/Infra:** AWS (ECS, Lambda, SQS, EventBridge, S3, CloudWatch, DynamoDB, CDK), Docker, Linux, CI/CD, IaC  
- **Quality/Obs:** pytest, Sentry, Elastic Stack, CloudWatch, Langfuse  
