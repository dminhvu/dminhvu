...
- Currently deep in compiler construction and static analysis, building toward LLVM/MLIR:
  ...
  MLIR dialect lowered end to end. Writing each one up on [dminhvu.com](https://dminhvu.com).
- Building **[workingstudentjobs.de](https://www.workingstudentjobs.de)** — helping international
...
- **Software Engineer (Working Student) @ [Flowzar GmbH](https://flowzar.com)**, Munich
  (Oct 2025 – Jul 2026) — FinTech cash flow forecasting platform: financial data ingestion
  pipelines, PostgreSQL event sourcing, LLM-assisted schema validation (FastAPI, React, PostgreSQL).
- **Software Engineer @ Coder Trove** (Jul 2024 – Sep 2025) — **[Grapple AI](https://ai.grapple.com.au)**,
  AI-powered invoice financing. Production GenAI platform on AWS; document processing 20+ min →
  under 2 min, per-assessment cost cut 75% via caching (80–90% hit rate).
- **Software Engineer @ ENTIIS Pte Ltd** (Feb 2022 – Jun 2024) — enterprise observability
  platform for banking and government clients. Built the log ingestion and parsing layer across
...
- **Systems & Compilers (MSc focus):** compiler construction, static program analysis, JVM
  internals & GC, parallel programming, distributed algorithms, algorithms & data structures
